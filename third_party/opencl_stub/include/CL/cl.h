...
/* Qualcomm Technologies, Inc. change: Set OpenCL version to 3.0
 * This change sets the OpenCL API version to 3.0
 * Application developers may
 *  - use these headers as is
 *  - use the original headers from Khronos
 *  - provide their own definition for CL_TARGET_OPENCL_VERSION
 */
...
/* Qualcomm Technologies, Inc. change: support 2.0 functions deprecated in 3.0 headers */
