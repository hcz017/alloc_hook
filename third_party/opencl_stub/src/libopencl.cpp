...
#ifndef MGB_CL_CUSTOM_PATH
#define MGB_CL_CUSTOM_PATH ""
#endif

#define MGB_CL_TO_STRS(s)           #s
#define MGB_CL_TO_STR(s)            MGB_CL_TO_STRS(s)
#define MGB_CL_CUSTOM_PATH_STR MGB_CL_TO_STR(MGB_CL_CUSTOM_PATH)
...
static void* get_library_handle() {
    ...
    if (!path && sizeof(MGB_CL_CUSTOM_PATH_STR)) {
        str = MGB_CL_CUSTOM_PATH_STR;
        try_custom_config();
    }
